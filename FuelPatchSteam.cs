...
{
    [HarmonyPatch(typeof(SteamLocomotive))]
    [HarmonyPatch("PeriodicUpdate")]
    class FuelPatchSteam
    {
        static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator il)
        {
            var codes = new List<CodeInstruction>(instructions);
            var methodToCall = typeof(SteamLocomotive).BaseType.GetMethod("PeriodicUpdate", BindingFlags.Instance | BindingFlags.NonPublic);
        ...
        static bool CheckCondition(SteamLocomotive __instance)
        {
        ...
        static void AdditionalBehavior(SteamLocomotive __instance)
        {
            Debug.Log("Executing additional behavior for SteamLocomotive.");
